![Symbols'n'Signs banner showing off all symbol items and the Display Panel block entities](https://raw.githubusercontent.com/the-drunken-cod/Symbols-n-Signs/refs/heads/develop/.github/assets/banner.png)
...
Code is licensed under the [AGPL-3.0-only.](https://github.com/the-drunken-cod/Symbols-n-Signs/blob/develop/LICENSE.txt)  
Original resources and assets in `common/src/main/resources/` are licensed under [MIT](https://github.com/the-drunken-cod/Symbols-n-Signs/blob/develop/src/main/resources/LICENSE.txt) unless otherwise stated.
