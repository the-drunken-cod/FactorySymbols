...
public enum SignType {
        ...
        HAZARD_ANIMALS_CROSSING_LEFT("hazard_animals_crossing_left", SignCategory.HAZARD, SignSupportType.BOTTOM),
        HAZARD_ANIMALS_CROSSING_RIGHT("hazard_animals_crossing_right", SignCategory.HAZARD, SignSupportType.BOTTOM),
