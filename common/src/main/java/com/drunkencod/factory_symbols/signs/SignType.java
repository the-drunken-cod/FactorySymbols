...
public enum SignType {
    ...
    REGULATORY_STRAIGHT_OR_RIGHT("regulatory_straight_or_right", SignCategory.REGULATORY), // [x]
    REGULATORY_STRAIGHT_OR_LEFT("regulatory_straight_or_left", SignCategory.REGULATORY), // [x]
    REGULATORY_LEFT_OR_RIGHT("regulatory_left_or_right", SignCategory.REGULATORY), // [x]
    REGULATORY_ROUNDABOUT("regulatory_roundabout", SignCategory.REGULATORY), // [x]
    REGULATORY_PEDESTRIANS_ONLY("regulatory_pedestrians_only", SignCategory.REGULATORY), // [x]
    REGULATORY_END_OF_RESTRICTIONS("regulatory_end_of_restrictions", SignCategory.REGULATORY), // [x]
    REGULATORY_SPEED_LIMIT_5("regulatory_speed_limit_5", SignCategory.REGULATORY), // [x]
    REGULATORY_SPEED_LIMIT_10("regulatory_speed_limit_10", SignCategory.REGULATORY), // [x]
    REGULATORY_SPEED_LIMIT_20("regulatory_speed_limit_20", SignCategory.REGULATORY), // [x]
    REGULATORY_SPEED_LIMIT_30("regulatory_speed_limit_30", SignCategory.REGULATORY), // [x]
    REGULATORY_SPEED_LIMIT_40("regulatory_speed_limit_40", SignCategory.REGULATORY), // [x]
    REGULATORY_SPEED_LIMIT_50("regulatory_speed_limit_50", SignCategory.REGULATORY), // [x]
    REGULATORY_SPEED_LIMIT_60("regulatory_speed_limit_60", SignCategory.REGULATORY), // [x]
    REGULATORY_SPEED_LIMIT_67("regulatory_speed_limit_67", SignCategory.REGULATORY), // [x]
    REGULATORY_SPEED_LIMIT_70("regulatory_speed_limit_70", SignCategory.REGULATORY), // [x]
    REGULATORY_SPEED_LIMIT_80("regulatory_speed_limit_80", SignCategory.REGULATORY), // [x]
    REGULATORY_SPEED_LIMIT_90("regulatory_speed_limit_90", SignCategory.REGULATORY), // [x]
    REGULATORY_SPEED_LIMIT_100("regulatory_speed_limit_100", SignCategory.REGULATORY), // [x]
    REGULATORY_SPEED_LIMIT_110("regulatory_speed_limit_110", SignCategory.REGULATORY), // [x]
    REGULATORY_SPEED_LIMIT_120("regulatory_speed_limit_120", SignCategory.REGULATORY), // [x]
    REGULATORY_SPEED_LIMIT_130("regulatory_speed_limit_130", SignCategory.REGULATORY), // [x]
    REGULATORY_SPEED_LIMIT_140("regulatory_speed_limit_140", SignCategory.REGULATORY), // [x]
    REGULATORY_SPEED_LIMIT_150("regulatory_speed_limit_150", SignCategory.REGULATORY), // [x]
    REGULATORY_SPEED_LIMIT_160("regulatory_speed_limit_160", SignCategory.REGULATORY), // [x]
    REGULATORY_SPEED_LIMIT_170("regulatory_speed_limit_170", SignCategory.REGULATORY), // [x]
    REGULATORY_SPEED_LIMIT_180("regulatory_speed_limit_180", SignCategory.REGULATORY), // [x]
    REGULATORY_SPEED_LIMIT_190("regulatory_speed_limit_190", SignCategory.REGULATORY), // [x]
    REGULATORY_SPEED_LIMIT_200("regulatory_speed_limit_200", SignCategory.REGULATORY), // [x]
    REGULATORY_SPEED_LIMIT_210("regulatory_speed_limit_210", SignCategory.REGULATORY), // [x]
    REGULATORY_SPEED_LIMIT_220("regulatory_speed_limit_220", SignCategory.REGULATORY), // [x]
    REGULATORY_SPEED_LIMIT_230("regulatory_speed_limit_230", SignCategory.REGULATORY), // [x]
    REGULATORY_SPEED_LIMIT_240("regulatory_speed_limit_240", SignCategory.REGULATORY), // [x]
    REGULATORY_SPEED_LIMIT_250("regulatory_speed_limit_250", SignCategory.REGULATORY), // [x]
