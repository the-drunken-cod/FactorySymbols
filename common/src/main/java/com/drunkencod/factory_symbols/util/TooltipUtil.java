package com.drunkencod.factory_symbols.util;
...
public class TooltipUtil {
    ...
    public static ItemLore getItemTooltip(String itemRegistryName) {
        return getTooltip("item.factory_symbols." + itemRegistryName + ".tooltip");
    }
    ...
    public static ItemLore getBlockTooltip(String itemRegistryName) {
        return getTooltip("block.factory_symbols." + itemRegistryName + ".tooltip");
    }
}
