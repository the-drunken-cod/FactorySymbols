---
name: Bug report
about: Report a bug with Symbols'n'Signs
title: ''
labels: bug
assignees: Sv443
...
- [ ] I am using the latest version of Symbols'n'Signs (matching [the latest release](https://github.com/the-drunken-cod/Symbols-n-Signs/releases/latest)).
